...
> Here was a short section about related but off topic thoughts on aspects of group related *economic* fairness (economics and to some extent education was considered but *not* other topics). These are temporarily hidden, since I'd like to think more and invest more time to consider all possible view points and experiences, but for the moment the focus here is on coronaviruses. The hidden drafts are still accessible through the github history function (github commits in late December 2020) <!--or as comment on the markdown file--> . I intend to republish the thoughts in spring or summer 2021 - asking for feedback and then better considering different view points and experiences.
