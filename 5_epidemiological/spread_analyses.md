...
### Exchanged Air is associated to the Covid Spread
...
* High population densities which are often associated with dense [living conditions](#living-space-and-income) are common.
...
* [Contact Tracing in Hong Kong](../5_epidemiological/individual_susceptibility_and_transmission.md#summary-adam) revealed that transmission in social settings (bars, weddings, temples) was associated with more secondary cases than households. A possible  explanation is that superspreading is more driver by lower respiratory tract infections which in turn are likely to induce such infections and this lower respiratory tract infections are both harder to prevent and more likely to spread.
