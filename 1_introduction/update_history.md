...
>
>> Despite the worries about RNA transfection, I often considered finding an alternative to best way to go - since as long as there wasn't an alternative, any concerns that weren't bullet proof - and against a tech for which few of the technical workings are published this is not easy - usually were just ignored or even torn into pieces. Also from a scientific viewpoint, to understand coronaviruses what they do and how to tame them, to find a prevention and/or treatment which is known to be safe seemed to be easier than accurately judging the safety of RNA transfection. [Interferons](./../6_prevention_and_treatment/interferon.md) look good.
