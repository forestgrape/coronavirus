...
>
>> 3./4.12.21: originally I was mainly afraid that RNA transfection could mess with RNAi pathways and possibly even pieces could be reverse transcribed, which then in turn could e.g. cause immune disorders. Also I had some concern about replication capable cell transfection, but I abandoned that until late spring (I don't exactly remember why, though I recall some non satisfying searches for resources on the cell tropism and then it possibly just got under in the sea of topics to work on). Back to RNAi: I did some (re)search and dived into RNAi in insects. I considered it as possible to be a concern due to codon optimization which is not or less the case for viruses (//I am not sure about it right now but there are enough other concerning things anyways known by now). When trying to work things out, I kind of got overwhelmed by all the "astronauts", piRNA, miRNA, ... at some point I thought I am mostly through for insects, but then translation to vertebrates turned out to be not straight forward since back then my knowledge of immunology was very limited both for insects and for vertebrates (visible from the state of the immune page back then). Therefore I wasn't in the position to judge which findings from insects translate to vertebrates - also I needed more reading which cells do when RNAi in mammals. I probably correctly hesitated to publish concerns about reverse transcription for a couple of reasons: 1) there was hope vaccines are useful 2) I didn't want to publish something I only guessed but lacked understanding especially not about vaccines 3) I intended to apply at health authorities. So I mostly moved back to coronaviruses for the coming months. Though from time to time I went back and dived into papers around the non structural RNAs and what they do: How the RNA is processed in the cells, how and which immune responses can be triggered, how cells differentiate and the roles of RNA in cellular communication. While I am still unsure about the original concerns about messing around with RNAi (whether it could happen and whether it is a concern) these interdisciplinary readings in late spring and early summer give rise to the chapter [Vaccine Safety Questions](../10_vaccines/vaccine_safety.md).  
