...
>> 3./4.12.21: originally I was afraid the RNA transfection could infer with the RNAi and possibly even pieces could be reverse transcribed. I did some (re)search and dived into RNAi in insects and thought it is to worry. I considered it as possible to be a concern due to codon optimization (//I am not sure about it right now but there are enough other concerning things anyways known by now). When trying to better understand what could go wrong, I kind of got overwhelmed by all the "astronauts", piRNA, miRNA, ... Also my knowledge of immunology was very limited back then both for insects and for vertebrates, therefore I wasn't in the position to judge which observations and possibilities from insects translate to the vertebrate immune system - also even fairly recent papers didn't agree on the role of RNAi in mammals. I probably correctly hesitated to publish concerns about reverse transcription for a couple of reasons: 1) there was hope vaccines are useful 2) I didn't want to publish something I only guessed but lacked understanding especially not about vaccines 3) I intended to apply at health authorities. After getting somewhat lost in the topic, I mostly moved back to coronaviruses for the coming months. Though from time to time I went back and dived into papers related to the topic: How the RNA is processed in the cells, how and which immune responses can be triggered, how cells differentiate and the roles of RNA in cellular communication. This interdisciplinary readings finally founded the chapter [Vaccine Safety Questions](../10_vaccines/vaccine_safety.md).  
