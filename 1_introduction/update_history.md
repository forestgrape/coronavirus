...
>
>> 3./4.12.21: originally I was mainly afraid that RNA transfection could mess with RNAi pathways and pieces could be reverse transcribed, which in turn could e.g. cause immune disorders. Also I had some concern about replication capable cell transfection, but I abandoned that until late spring (I don't exactly remember why, though I recall some non satisfying searches for resources on the cell tropism and then it possibly just got under in the sea of topics to work on). Back to RNAi: I did some (re)search and dived into RNAi in insects. I considered it as possible to be a concern due to codon optimization which is not or less the case for viruses. At some point I thought I am mostly through for insects: Virus derived RNA is communicated among cells and possibly inherited. I commented with '[in advanced work]'. However he translation to vertebrates turned out to be not straight forward and so I struggled. One reason was, that back then my knowledge of immunology was limited both for insects and for vertebrates (visible from the state of the immune page back then). Additionally I struggled to fully grasp RNAi in mammals and I kinda got overwhelmed by all the "astronauts" and piRNA, miRNA, ... I hesitated respectively kept putting off to publish concerns about reverse transcription for a couple of reasons: 1) there was hope vaccines are useful so I didn't want to spread out false concerns 2) I didn't want to publish something I mostly guessed but lacked understanding especially not about a sensible topic such as reverse transcription of vaccines is 3) I intended to apply at health authorities (my attitude to vaccines was already critical enough). 4) I didn't think it will have much effect without rigorous founding since I even failed to convince my closest to do at least an antibody test before vaccination, nearly all of them. 
I mostly worked on coronaviruses during these months. The ongoing Covid through spring 2021 often seemed more pressing than some hypothetical possibility of reverse transcription and it wasn't even clear if it happens whether it can have adverse effects. Though from time to time I went back and dived into papers around the non structural RNAs and what they do: How the RNA is processed in the cells, how and which immune responses can be triggered, how cells differentiate and the roles of RNA in cellular communication. While I am still unsure about the original concerns about messing around with RNAi (whether it could happen and whether it is a concern) these interdisciplinary readings in late spring and early summer give rise to the chapter [Vaccine Safety Questions](../10_vaccines/vaccine_safety.md).

>> 3./4.12.21: As RNA vaccines turned out they don't tame SARS-CoV-2, from a coronavirus perspective alone one should stop mass vaccination even when the vaccines are safe(3.12.21). To understand coronaviruses what they do and how to tame them, to find a prevention and/or treatment which is known to be safe seemed/is (!) easier than proofing or dis-proofing safety of RNA transfection. [Interferons](./../6_prevention_and_treatment/interferon.md) look promising.
