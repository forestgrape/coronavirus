...
> Entire page is **in work, incomplete and needs to be checked**. A main reason for the early publishing is the [literature list](#key-literature-and-recommended-readings) on which inspires and founds this chapter. 
...
* [Key Literature and recommended Readings](#key-literature-and-recommended-readings)
* [Key Observations (Somewhat Technical)](#key-observations-somewhat-technical)
* [References](#references)
  ...
  * [References Cellular Immunity](#references-cellular-immunity)



## Conceptual Summary 
The human immune system develops throughout the lifetime and its development is closely interlinked with ageing from birth to death and with pathogens encountered at different entry locations. 
* At young age the recognition of unknown pathogens and learn to handle them is good. This is achieved by strong innate pathogen recognition mechanisms and a fast transport of recognized pathogens to the lymph nodes (e.g. through dendritic cell migration). While the learning mechanisms work well, nearly all pathogens are completely new and so the recognition often relies on innate pathogen recognition mechanisms alone.

* After a few years of life the immune system is already strong since it has encountered many pathogens and learned: Surveillance and protection at frequent pathogen entry locations and a repertoire of mechanism to adequately handle different pathogens. 

* In early adulthood the ability the learn completely new pathogens decreases since the innate recognition mechanism are relaxed. However learning of pathogens similar to existing ones is still strong.

* With increasing age the ability to handle new pathogens diminishes and the immune system more and more relies on a large immune memory built up throughout life. Nevertheless learning to recognize new pathogens still is possible although slower.

* At old to very old age immune cells are subject to senescence. Many cellular pathways don't work as perfectly anymore which causes 
  * constantly some stress to the cells which in turn causes some inflammation. To prevent autoimmunity the inflammation needs to be controlled and therefore the immune system is more relaxed regarding sensing cell stress. This relaxation limits danger recognition by the innate immune system.
  * which can reduce the functionality. E.g. cells taking up and carrying antigens to antibody producing cells migrate slower (dendritic cells take up pathogen part and bring them to the lymph nodes where an interplay between CD4 T cells and B cells induces antibody production). Cells can reach end of life (mostly by apoptosis) whereby some acquired memory is lost.
...
At young age the immune system is built to encounter new pathogens and handle them appropriately. It is well known that if one encounters a disease for the first time as adult, the disease is much more severe.

* For infants and children SARS-CoV-2 is just another new virus e.g. like the other endemic human coronaviruses. For coronavirus unexposed people , the current SARS-CoV-2 strains are even less pathogenic than the endemic human coronaviruses since the endemic coronaviruses have adapted the evade the human immune system.
...
* Innate immune recognition works best at young age:
  ...
  * At high age, endoplasmatic reticulum stress is common in many cells and to keep homeostasis the associated danger signals are down regulated, which reduces the chance to detect many positive stranded RNA viruses by ER stress [to confirm and cite].

* At young age the homeostasis is more focussed on infection prevention whereas with increasing age to homeostasis shifts towards dirt cleaning:
  ...
  * [Loske et al](#loske) show in Fig 1 that in uninfected adults, few immune cells are present and most cells present in the upper respiratory tract are ciliated or structural cells. In children on the other hand even when not infected the cell landscape resembles that during infection: Neutrophils, different groups of T cells and B cells are present in quite high numbers.

* Initiating an immune response is faster in young age:
    * [Zhao et al](#summary-zhao) observe that in mice dendritic cells migrate slower to the lymph nodes.
...
* With increasing age the immune system relies more and more on the acquired immunity built up throughout lifetime and is less good at building up new acquired immunity:
  * Throughout life the distribution of T cells shifts from naive T cells shift to effector T cells ([Kumar et al](#kumar): Figure 3, [Zheng et al](#zheng): Figure 2 B by RNA seq and 2 C by mass cytometry). The shift is strongest at the mucosal sites such as the intestine and the lungs (Figure 3 in [Kumar](#kumar)).

  * The T cell and B cell receptor diversity is highest at young age. With increasing age the diversity decreases while the receptors have higher degrees of rearrangements ([Zheng et al](#zheng): Text and Figure 5) and are selected by previous pathogen exposure [to confirm and city]. It is to except that the immune response is de novo optimized for SARS-2 in young people, while in older it is strongly influenced by the endemic human coronaviruses - in agreement [Selva et al](#selva) observe that older people more likely have antibodies targeting the S2 domain of S or the nucleocapsid protein which have a higher conservations rate across coronaviruses (to target epitopes in S2 and N has the advantage that these epitopes are less likely to mutate and when they mutate negative effects on the virus viability is more likely than e.g. for S1 domain mutations).
...
### T Cells
Early in life the majority of T cells are in the naive state. A naive cells able to recognize something useful can induce a memory version of itself. The shift towards predominately memory cells occurs in the first years of life in the intestine and during the first two decades in the lungs.
...
#### Protection Provided
* Strong Innate Defense but only partly optimised to entry locations.
* Nearly no acquired immunity. Naive T cell are present throughout the body but no/few memory cells have  are established [to check (theoretically memory cell could be established as foetus since in humans but not in mice T cells are already present) and cite].
