...
* [Selected Literature on the Immune System](#selected-literature-on-the-immune-system)
* [Selected Literature on the Immune System and Covid](#selected-literature-on-the-immune-system-and-covid)
* [Observations group by Mechanism](#observations-group-by-mechanism)
...
## Conceptual Summary
The human immune system develops throughout the lifetime and its development is closely interlinked with ageing from birth to death. The microbes encountered at the different entry locations shape and train the immune system locally.

* As infant the recognition of unknown pathogens and learn to handle them is good. This is achieved by strong innate recognition mechanisms and the immune system is in a state of permanent alertness. However many pathogens are completely new and for these, the recognition  relies on innate pathogen recognition mechanisms alone. Additionally the entry locations, how to handle & control the different classes of pathogens needs to be fine tuned and sometimes even needs to be learned. Sometimes infants need to initiate high fever to control virus infections - which has high costs  temporary fitness costs but reduces many virus infection efficiently.
...
* In early adulthood the ability the learn completely new pathogens decreases since the innate recognition mechanism are relaxed. The homeostasis is focussed on functionality. However the recognition and learning of pathogens similar to existing ones is strong due to the gained experiences at which locations which pathogens enter.

* With increasing age the ability to handle new pathogens diminishes and the immune system more and more relies on a large immune memory built up throughout life. Nevertheless learning to recognize new pathogens - especially if the pathogens have similarities to encountered ones - is still possible although slower.
...
* For adolescents and young adults SARS-CoV-2 is not dangerous neither, since while being a new virus, it is not a completely new virus since SARS-CoV-2 is close to the endemic human coronaviruses. Both innate and acquired (mainly coronavirus-cross-reactive tissue resident T cells) immune mechanisms recognize the infection. The pool of naive immune cells is still large enough and even shaped to recognize coronaviruses to give rise to an adequate  and virus clearing immune response. Nearly always an effective immune response is timely enough to prevent the viruses spreading throughout the lungs and thus severe disease is prevented.

* With increasing age the recognition of new viruses and the capabilities to handle them decreases. Additionally the body works slower which delays a timely immune response. One of the key shortcomings is the shortage of naive T cells with are the basis of acquired immune responses, accordingly [Moderbacher et al](#moderbacher) observe that severe Covid is well correlated to severe Covid.



## Selected Literature on the Immune System
...
## Selected Literature on the Immune System and Covid
...
## Observations group by Mechanism
...
#### References
[Kollmanm et al](#kollmann), remarks that the immune system niches are populated as fetus in [Kumar et al](#kumar)
...
The Journal of clinical investigation, 121(12), 4921–4930. <https://doi.org/10.1172/JCI59777>
...
Journal of immunology (Baltimore, Md. : 1950), 199(3), 1060–1068. <https://doi.org/10.4049/jimmunol.1700397>
