...
* With increasing age the immune system more and more relies on a large immune memory built up throughout life. Nevertheless learning to handle new pathogens - especially if the pathogens have similarities to encountered ones - is still possible although slower.

* At old to very old age, cells including are subject to senescence. The cells and the body do not work as perfectly anymore:
  * Often something is detected out of order - even without pathogens - which can cause inflammation. To prevent autoimmunity the inflammation needs to be controlled and therefore the immune system alarming is more relaxed.
