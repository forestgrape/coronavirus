...
## Updates
### Recent Topics Added
- 24.11.: [Interferon Treatment](6_prevention_and_treatment/interferon.md): Early interferon treatment helps to reduce the viral load and helps to prevent progression to severe disease. Early interferon alpha treatment shows the best results with mortality reductions above 75%. Topical administration to the respiratory tract (spray or nebulized) shows some benefits even in mid to advanced disease stages. Systemically applied interferons (especially IFN beta) on the other hand yield adverse outcomes when applied late. => 1) Topical IFN alpha is recommended to treat SARS-CoV-2 infection and treatment should start as early as possible. 2) Systemic or topical IFNs are recommended as prophylaxis for risk groups upon exposure or at high incidence rates of severe Covid.
