...
- 6.11. Renamed ~~"Monitor Failure"~~ to [Estimates Out of Bounds](./monitor_and_control.md#detect-estimates-out-of-bounds). Case numbers are case numbers and not estimates. 
    >Mainly I was shocked by very steep increase of deaths and still am [analyses in work]. I spent/d a lot of time doing analyses and tend to get the estimates (including those I don't like).
