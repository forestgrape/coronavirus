...
- > 9.12. Transparency of adverse Effects
  > If there would be possible adverse effects from the vaccines, in my opinion the most important is to go transparently public with these: A fond for the affected can be founded. Supervision and if necessary treatments or other precautions measures could be initiated for those affected.
