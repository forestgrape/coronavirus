...
* [Diagnosis](#diagnosis)
  * [Diagnosis Relevance](#diagnosis-relevance)
  * [Diagnosis Methods](#diagnosis-methods)
* [Viral Load and Diagnosis](#viral-load-and-diagnosis)
...
## Public Description
Covid-19 can have many forms and accompanying [symptoms](#symptoms). The symptoms differ a lot since they depend on the tissues which are infected. Any kind of respiratory symptoms (except a hoarse voice) can indicate Covid-19. In risk regions with such symptoms one should avoid crowded indoor spaces and do a Covid test. 
However many of the symptoms are not specific to Covid-19, they can have other causes than SARS-CoV-2: having a (respiratory) infection with another virus or even bacteria, having eaten/drunken something harmful (e.g. rotten or too much alcohol and the like), not having had enough sleep.
...
> ##### Disease
> A *disease* is a biological disorder of structure or function in an organism causing inconvenience and unwanted effects. Often an immune system response is induced. Literally without-ease (dis=without, separated from). 

There are many different forms of diseases. Here only virus diseases are discussed.

> ##### Virus disease
> A *virus disease* is a [virus infection of an organism] causing adverse effects. Such effects can be either directly through tissue damage caused by viruses or by (side effects) of the immune response.

How a virus disease behaves is an interplay of host factors including the host immune system, the behavior of the virus and environmental factors.
...
* __Host factors__ relevant for the tropism of Covid-19 are
    ...
    - Host immune system response. The immune system is described on the [immune system page](./immune_system.md). The immune response depends on the  and how much and were
...
* __Environmental Factors__
 ...
 Where and how much viruses infect different locations determines the disordering of the tissues directly and indirectly through the immune response induced.


## Infection Locations
SARS-CoV-2 can infect different tissues in humans, described on the coronavirus page in the section [tissue tropism](./coronavirus.md#tissue-tropism-of-sars-cov-2)
* the upper respiratory tract => Symptoms are similar to other respiratory diseases: a sore throat, coughing and a runny nose. Loss of smell or taste occurs too and is more specific to Covid-19. 
* the throat => Coughing, the body wants to get rid of the viruses in the respiratory tract.
* main bronchi => Dry cough.
* the deep lungs i.e. small bronchi, alveoli => If the lungs get involved, symptoms can be a strange feeling in the chest like something sticky being inside (dry mucus loaded with viruses) or even shortness of breath (the lungs are inflamed). Diarrhea can both start early and later on and can outlast the respiratory infection by days or even weeks.
* virions in the alveoli and spread to the blood => Early on virions are released into the blood. All in all this feels like it is starting from within. Symptoms can be chills (because the body is increasing the temperature to fight the viruses) or just strange feeling, similar to a weak poisoning when having eaten something rotten or drunken too much. Feeling tired, energy-less and having an increased recovery time after sports are indications too.
...
### Diagnosis Methods
When a virus replicates inside a cell the virus produces new rough copies of itself called virions. These virions consist of a genome (encoded in a storage format: RNA or DNA) and proteins. To detect viruses replicating inside cells these building blocks are measured. 
* RNA
  * the storage RNA i.e. the RNA making up the genome of virions
   By this method the amount of virions - called [viral load](#viral-load) - present can be determined with high specificity. 
  * temporary RNA produced during active virus replication
   This method can be used to detect whether the viruses are currently replicating. 
* Proteins of virions
  Methods detecting proteins of virions are usually called **antigen tests** (since the virus proteins can be recognized by the immune system as harmful and antibodies can be produced against them)
* Tissue damage
  * chemical e.g. detecting cell damage by detecting distinctive proteins.
  * optical e.g. round glassy occupancies in the lung are typical for Covid
  (+) specific
  (-) radiation exposure for patient
  (-) only in diseases involving the lung severely thus sensitivity low
* 
...
#### Lee
A carefully carried out review and meta analysis.  with very helpful graphics
...
##### Results
For 216 of the 224 patients had analyzed both samples without errors (9 errors in total).

Salvia\Swab | Swab positive | Swab negative | Total
--|--|--|--
Saliva positive | 38        | 1             | 39 
Salvia negative |  0        | 177           | 177
Total           | 38        | 178           | 216 
